    ...
    return(
        <div className='block border-separate bg-background md:hidden'>
            <nav className='container flex items-center justify-between px-8'>
                <Sheet open={isOpen} onOpenChange={setIsOpen}>
                    ...
                    <SheetContent className="w-[300px] sm:w-[540px]" side="left">
                        <Link href="/" className='text-3xl  border-b border-separate dark:border-white font-bold text-center'>LetsStudy</Link>
            ...
            <div className='border-t items-center flex justify-center '>
              <p className='mt-6'>&copy; 2024 LetsStudy</p>
            </div>
    ...
    return(
        <div className='hidden border-separate border-b  bg-background md:block'>
          <div className='w-full flex justify-between items-center'>
            <Link href="/" className='text-4xl font-bold p-4'>LetsStudy</Link>
