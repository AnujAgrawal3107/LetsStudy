...
const MobileFooter = ()=>{
    return(
        ...
        <div className=" mt-10">
            <h1 className="flex text-lg  font-bold items-center justify-center">&copy; LetsStudy 2024</h1>
        </div>
...
const DesktopFooter = () => {
  return (
    <div className="w-full h-52 md:h-30 lg:h-48  max-lg:hidden bg-transparent bottom-0 flex">
        ...
        <Link href="/" className="text-4xl p-4 mt-8">LetsStudy</Link>
    <h1 className="text-lg p-4 mt-8">Quick Links
    <div className="flex flex-col mt-4">
        <a href="/" className="hover:text-blue-700 duration-150 cursor-pointer">Github</a>
        <a href="/" className="hover:text-blue-700 duration-150 cursor-pointer">About Dev</a>
        <a href="/" className="hover:text-blue-700 duration-150 cursor-pointer">Docs</a>  
    </div>
    </h1>
        </div>
